...
export const FANTASY_ITEMS = [
  ...
  { name: 'Harmanpreet Kaur', image: '' },
  { name: 'Babar Azam', image: '' },
  { name: 'Shaheen Afridi', image: '' },
  { name: 'Kane Williamson', image: '' },
  { name: 'Ben Stokes', image: '' },
  { name: 'Steve Smith', image: '' },
  { name: 'David Warner', image: '' },
  { name: 'Rashid Khan', image: '' },
  { name: 'Trent Boult', image: '' },
]
