...
const FAQS = [
  ...
  ['Can I buy points in a free room?', 'Yes, and you never have to. Everyone starts a free room on the same purse; point packs (1, 5, 10 or 20 MON) buy you a bigger paddle if you want one. Points are a score inside that one room — they are not a currency, cannot be moved between rooms, cannot be converted back to MON, and are non-refundable. MON rooms have no packs, because there you already bid your own real MON directly.'],
  ['Who pays for all this?', 'Whoever is transacting. BidBlitz has no server-side wallet and cannot spend on your behalf: in a MON room the host pays gas for the lots they start and sell, and each bidder pays for their own bids. Free rooms cost nothing to play because nothing in them touches a chain — optional point packs are what keep the lights on.'],
